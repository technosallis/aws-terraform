resource "aws_instance" "phpapp" {
  ...
  echo "\$conn = new mysqli('mydatabase.technosallis.internal', 'root', 'secret', 'test');" >> /var/www/html/calldb.php
...
resource "aws_instance" "database" {
  ...
  mysql -u root -psecret -e "INSERT INTO mytable (mycol) values ('technosallisisgreat') ;" test
HEREDOC
}
